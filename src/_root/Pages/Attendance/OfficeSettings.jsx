...
const OfficeSettings = () => {
  ...
  return (
    <div className="h-screen">
      <div
        className="flex items-center space-x-1 px-2 py-2 text-gray-700 "
        // style={{
      ...
      >
        ...
        <h2 className="px-2 py-1 text-gray-700 text-sm font-bold">
        ...
        <div className="col-span-8 md:col-span-3 ">
          {isEditing ? (
            <div className="space-y-4 text-black">
              ...
              <button
                className="w-full py-2 text-white text-[.7rem] font-bold rounded-md"
