...
const Summary = () => {
  ...
  const handleClick = () => {
    ...
    // Remove the animation class after it completes (1.2 seconds here)
    setTimeout(() => {
      setAnimate(false);
    }, 500);
  };
  return (
    <div>
      <div className=" bg-white bg-opacity-40 backdrop-filter backdrop-blur-md rounded-lg shadow-lg w-full  ">
        {/* Main Tabs */}
            ...
            <button
              ...
              className={`flex-1 text-left py-3  px-4 ${
                activeMainTab === "summary"
                  ? "bg-pink-500 rounded-md  text-white"
            ...
            <button
              ...
              className={`flex-1 text-left py-2 px-4 relative overflow-hidden ${
                activeMainTab === "calls-count"
                  ? "bg-pink-500 rounded-md mt-3 font-semibold text-white"
                  : "text-black font-bold"
              } ${animate ? "water-flow" : ""}`}
            >
              CALLS COUNT
